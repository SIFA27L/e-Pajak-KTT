...
<body>
    <button onclick="window.print()" class="no-print" style="padding: 10px 20px; background: #0ea5e9; color: white; border: none; border-radius: 5px; cursor: pointer; margin-bottom: 20px;">
        Print / Save as PDF
    </button>
    ...
    <h2 style="color: #0ea5e9; border-bottom: 2px solid #0ea5e9; padding-bottom: 10px;"><?php echo $title; ?></h2>
